...
class UserController extends Controller
{
    ...
    public function ad()
    {
        ...
        if(!$check || !array_key_exists('qrcode', $check) || !array_key_exists('url', $check->qrcode) || !array_key_exists('expire', $check->qrcode) || intval($check->qrcode->expire) < time()) $use = $this->setQrcode();
